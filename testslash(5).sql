...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 09 déc. 2022 à 08:17
...
CREATE TABLE IF NOT EXISTS `chrono` (
  `chrono_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `evenements` (
  `evenement_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `metiers` (
  ...
  `id_utilisateur` int(10) UNSIGNED NOT NULL,
  `id_sphere` int(10) UNSIGNED NOT NULL,
...
(3, 'Alex', 'alexisdev@gmail.com', '$2y$12$jKw2xG62LVrtGukN3W0GmuNyr1Lyex1EemHywzhy/i8go7eVAaESm', '3.gif', '2022-09-30 09:46:43', NULL, NULL),
