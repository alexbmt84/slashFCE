...
<body>
    <main class="main">
        <h2><span class="hello">Bienvenue, </span><br><?= $user->pseudo; ?> !</h2>
            ...
            <button id="btn-blue" class="btnAddTask">Ajouter des tâches</button>
            <button id="btn-blue1" class="btnAddTask" onclick="window.location.href='creation.php';">Retour</button>
