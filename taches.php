  ...
  <div class="modal-wrap">
    ...
    <div class="modal-bodies">
      <div class="modal-body modal-body-step-1 is-showing">
        ...
        <form action="core/modules/add_tache.php" method="POST" enctype="multipart/form-data">
        <div class="profile-pic">
          ...
          ?>
            <div class="title bleu">Début prévu : <input type="datetime-local" name="dateDebut" id="dateDebut" value="<?= $date->format("Y-m-d H:i"); ?>" required></div>
          </label>
